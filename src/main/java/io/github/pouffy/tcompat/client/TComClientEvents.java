...
public class TComClientEvents {
    ...
    static void clientSetup(FMLClientSetupEvent event) {
        ...
        setTranslucent(TCFluids.moltenZirconia);
    }
    ...
    public static void renderModifier(ModifierId modifier, CooldownInstance cooldownInstance, GuiGraphics guiGraphics, int x, int y) {
        ...
        matrixStack.translate(x + TCompatConfig.CLIENT.modifierCooldown_xOffset.get(), y + TCompatConfig.CLIENT.modifierCooldown_yOffset.get(), 0);
