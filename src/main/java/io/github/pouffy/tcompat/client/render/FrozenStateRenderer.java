package io.github.pouffy.tcompat.client.render;
...
public class FrozenStateRenderer {
    private static final ResourceLocation TEXTURE_0 = ResourceLocation.withDefaultNamespace("textures/block/frosted_ice_0.png");
    private static final ResourceLocation TEXTURE_1 = ResourceLocation.withDefaultNamespace("textures/block/frosted_ice_1.png");
    ...
    public void render(Entity entity, PoseStack matrixStack, MultiBufferSource bufferIn, int light) {
        ...
        AABB boundingBox = new AABB(-entity.getBbWidth() / 2F - sideExpand, 0, -entity.getBbWidth() / 2F - sideExpand,
                entity.getBbWidth() / 2F + sideExpand, entity.getBbHeight() + sideExpandY, entity.getBbWidth() / 2F + sideExpand);
        matrixStack.pushPose();
        renderMovingAABB(boundingBox, matrixStack, bufferIn, light, 255, getFrozenTicks(entity));
        matrixStack.popPose();
    }
    ...
    public void renderMovingAABB(AABB boundingBox, PoseStack stack, MultiBufferSource bufferIn, int light, int alpha, int frozenTicks) {
        RenderType rendertype = TCRenderTypes.getIce(getIceTexture(frozenTicks));
