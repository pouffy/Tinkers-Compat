...
public class TCFluidTextureProv extends AbstractFluidTextureProvider {
    ...
    public void addTextures() {
        ...
        slime(TCFluids.runicSap);
        slime(TCFluids.cursedSap);
        compatOre(TCFluids.moltenSoulStainedSteel);
        compatOre(TCFluids.moltenMalignantPewter);
        compatOre(TCFluids.moltenHallowedGold);
        compatOre(TCFluids.moltenBlazingQuartz);
        compatOre(TCFluids.moltenCthonicGold);
        compatOre(TCFluids.moltenMalignantLead);
        compatOre(TCFluids.moltenNecromium);
        compatOre(TCFluids.moltenSpinel);
        compatOre(TCFluids.moltenTurquoise);
        compatOre(TCFluids.moltenZirconia);
    }
