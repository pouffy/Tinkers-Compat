...
import io.github.pouffy.tcompat.common.capability.living.cryogenic.CryogenicCapability;
import io.github.pouffy.tcompat.common.capability.living.void_touched.VoidTouched;
import io.github.pouffy.tcompat.common.capability.living.void_touched.VoidTouchedCapability;
...
public class TCompatCapabilities {
    ...
    public static final Capability<Cryogenic> CRYOGENIC_CAPABILITY = CapabilityManager.get(new CapabilityToken<>() { });
    ...
    public static void register(RegisterCapabilitiesEvent event) {
        ...
        event.register(Cryogenic.class);
    ...
    public static class Registration {
        ...
        public static void attachEntityCapabilities(AttachCapabilitiesEvent<Entity> event) {
            ...
            if (event.getObject() instanceof LivingEntity livingEntity) {
                ...
                event.addCapability(TCompat.getResource("cryogenic"), new CapabilityProvider(TCompatCapabilities.CRYOGENIC_CAPABILITY, new CryogenicCapability(livingEntity)));
            }
