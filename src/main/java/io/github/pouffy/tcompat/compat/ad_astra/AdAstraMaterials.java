...
public class AdAstraMaterials {
    ...
    public static final MaterialId calorite = MaterialBuilder.material("ad_astra", "calorite")
            ...
            .spriteInfo(s -> s.fallbacks("metal").repairKit().armor().meleeHarvest().ranged().sixColor(0xFF470d2f, 0xFF6a1534, 0xFF9e1f3f, 0xFFb83145, 0xFFcb4e4f, 0xFFdf6d5c))
            .buildMaterial();
    ...
    public static final MaterialId desh = MaterialBuilder.material("ad_astra", "desh")
            ...
            .spriteInfo(s -> s.fallbacks("metal").repairKit().armor().meleeHarvest().ranged().sixColor(0xFF7a3045, 0xFF9e4539, 0xFFb25b3d, 0xFFc77142, 0xFFd68d4d, 0xFFe9ba5d))
            .buildMaterial();
    ...
    public static final MaterialId ostrum = MaterialBuilder.material("ad_astra", "ostrum")
            ...
            .spriteInfo(s -> s.fallbacks("metal").repairKit().armor().meleeHarvest().ranged().sixColor(0xFF42313d, 0xFF553e4b, 0xFF775360, 0xFF925e64, 0xFFa86c73, 0xFFbf7a82))
            .buildMaterial();
