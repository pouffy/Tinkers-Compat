...
public class BetterNetherSmeltery implements CompatSmeltery {
    ...
    public void addRecipes(Consumer<FinishedRecipe> consumer, String folder) {
        ...
        metal(cConsumer, BetternetherInit.moltenCincinnasite, compatModId()).ore().metal(4, true).optional();
        metal(cConsumer, BetternetherInit.moltenNetherRuby, compatModId()).ore().gem(9, true).optional();

        salvageAll(cConsumer, this::compatId, BetternetherInit.moltenNetherRuby, FluidValues.GEM, "nether_ruby", new int[]{FluidValues.GEM_SHARD, FluidValues.NUGGET}, gemFolder("melting"));
        salvageAll(cConsumer, this::compatId, BetternetherInit.moltenNetherRuby, FluidValues.GEM, "flaming_ruby", new int[]{FluidValues.GEM_SHARD, FluidValues.NUGGET}, gemFolder("melting"));
        salvageAll(cConsumer, this::compatId, BetternetherInit.moltenCincinnasite, FluidValues.INGOT, "cincinnasite", new int[]{FluidValues.NUGGET, FluidValues.NUGGET}, metalFolder("melting"));

        simpleMelting(cConsumer, BetternetherInit.moltenCincinnasite, FluidValues.INGOT, "cincinnasite", listedInput(
                "cincinnasite_button",
                "cincinnasite_chain",
                "nether_brewing_stand"
        ), metalFolder("melting"), "ingot_1");
        simpleMelting(cConsumer, BetternetherInit.moltenCincinnasite, FluidValues.INGOT * 2, "cincinnasite", listedInput(
                "cincinnasite_bricks",
        ...
        simpleMelting(cConsumer, BetternetherInit.moltenCincinnasite, FluidValues.INGOT * 4, "cincinnasite", listedInput(
                "cincinnasite_pillar",
        ...
        simpleMelting(cConsumer, BetternetherInit.moltenCincinnasite, 112, "cincinnasite", ItemNameIngredient.from(compatId("cincinnasite_small_lantern")), metalFolder("melting"), "small_lantern");
        simpleMelting(cConsumer, BetternetherInit.moltenCincinnasite, 144, "cincinnasite", ItemNameIngredient.from(compatId("cincinnasite_brick_plate")), metalFolder("melting"), "brick_plate");
        simpleMelting(cConsumer, BetternetherInit.moltenCincinnasite, FluidValues.INGOT * 16, "cincinnasite", listedInput("cincinnasite_forge", "cincinnasite_anvil", "chest_of_drawers"), metalFolder("melting"), "ingot_16");
        simpleMelting(cConsumer, BetternetherInit.moltenCincinnasite, FluidValues.INGOT * 6, "cincinnasite", listedInput("cincinnasite_stairs", "roof_tile_cincinnasite_stairs"), metalFolder("melting"), "stairs");
        simpleMelting(cConsumer, BetternetherInit.moltenCincinnasite, FluidValues.INGOT * 8, "cincinnasite", ItemNameIngredient.from(compatId("cincinnasite_plate")), metalFolder("melting"), "pressure_plate");
        simpleMelting(cConsumer, BetternetherInit.moltenCincinnasite, 22, "cincinnasite", ItemNameIngredient.from(compatId("cincinnasite_frame")), metalFolder("melting"), "frame");
        simpleMelting(cConsumer, BetternetherInit.moltenCincinnasite, FluidValues.INGOT * 12, "cincinnasite", ItemNameIngredient.from(compatId("cincinnasite_pedestal")), metalFolder("melting"), "pedestal");
        simpleMelting(cConsumer, BetternetherInit.moltenCincinnasite, FluidValues.NUGGET * 3, "cincinnasite", ItemNameIngredient.from(compatId("cincinnasite_bars")), metalFolder("melting"), "bars");
        simpleMelting(cConsumer, BetternetherInit.moltenCincinnasite, FluidValues.INGOT * 14, "cincinnasite", ItemNameIngredient.from(compatId("cincinnasite_fire_bowl")), metalFolder("melting"), "fire_bowl");

        simpleMelting(cConsumer, BetternetherInit.moltenNetherRuby, 1350, "nether_ruby", ItemNameIngredient.from(compatId("nether_ruby_stairs")), gemFolder("melting"), "stairs");
        simpleMelting(cConsumer, BetternetherInit.moltenNetherRuby, FluidValues.LARGE_GEM_BLOCK / 2, "nether_ruby", ItemNameIngredient.from(compatId("nether_ruby_slab")), gemFolder("melting"), "slab");

        simpleMelting(BetternetherInit.moltenCincinnasite, FluidValues.INGOT * 3, ItemNameIngredient.from(compatId("cincinnasite_pot")))
        ...
        simpleMelting(BetternetherInit.moltenCincinnasite, FluidValues.INGOT * 14, ItemNameIngredient.from(compatId("cincinnasite_fire_bowl_soul")))
                .addByproduct(TinkerFluids.liquidSoul.result(FluidValues.GLASS_BLOCK))
