...
public class AetherSmeltery implements CompatSmeltery {
    ...
    public void addRecipes(Consumer<FinishedRecipe> consumer, String folder) {
        ...
        //Generic Melting
        gem(cConsumer, AetherInit.moltenZanite, compatModId())
        ...
        metal(cConsumer, AetherInit.moltenGravitite, compatModId()).ore(TCByproduct.ZANITE).metal(true).optional();
        metal(cConsumer, AetherInit.moltenLightnum, compatModId()).metal(true).optional();
        metal(cConsumer, AetherInit.moltenDraculite, compatModId()).metal(true).optional();

        simpleMelting(cConsumer, AetherInit.moltenZanite, FluidValues.INGOT, "zanite", ItemNameIngredient.from(compatId("altar")), gemFolder("melting"), "altar");
        ...
        glovesMelting(cConsumer, AetherInit.moltenZanite, FluidValues.INGOT * 2, "zanite", ItemNameIngredient.from(compatId("zanite_gloves")), gemFolder("melting"), true, new int[]{FluidValues.GEM_SHARD});
        glovesMelting(cConsumer, AetherInit.moltenGravitite, FluidValues.INGOT * 2, "gravitite", ItemNameIngredient.from(compatId("gravitite_gloves")), metalFolder("melting"), true, new int[]{FluidValues.NUGGET});
        //Rings
        ...
        ringMelting(cConsumer, AetherInit.moltenZanite, FluidValues.INGOT * 4, "zanite", ItemNameIngredient.from(compatId("zanite_ring")), gemFolder("melting"), true);
        //Pendant
        ...
        pendantMelting(cConsumer, AetherInit.moltenZanite, FluidValues.INGOT, "zanite", ItemNameIngredient.from(compatId("zanite_pendant")), gemFolder("melting"), true);
        //Salvaging
        salvageAll(cConsumer, this::compatId, AetherInit.moltenZanite, FluidValues.INGOT, "zanite", new int[]{FluidValues.NUGGET}, gemFolder("melting"));
        salvageAll(cConsumer, this::compatId, AetherInit.moltenGravitite, FluidValues.INGOT, "gravitite", new int[]{FluidValues.NUGGET}, metalFolder("melting"));
        ...
        simpleMelting(cConsumer, AetherInit.moltenLightnum, FluidValues.INGOT * 2, "lightnum", ItemNameIngredient.from(compatId("lightning_sword")), metalFolder("melting"), "sword");
        simpleMelting(cConsumer, AetherInit.moltenLightnum, FluidValues.INGOT, "lightnum", ItemNameIngredient.from(compatId("lightning_knife")), metalFolder("melting"), "knife");
        simpleMelting(cConsumer, AetherInit.moltenDraculite, FluidValues.INGOT * 2, "draculite", ItemNameIngredient.from(compatId("vampire_blade")), metalFolder("melting"), "sword");
        simpleMelting(cConsumer, AetherInit.moltenDraculite, FluidValues.INGOT, "draculite", listedInput("life_shard", "regeneration_stone"), metalFolder("melting"), "ingot_1");
    }
