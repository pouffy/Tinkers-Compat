...
public class BetternetherMaterials {
    ...
    public static final MaterialId cincinnasite = MaterialBuilder.material("betternether", "cincinnasite")
            ...
            .spriteInfo(s -> s.fallbacks("metal").repairKit().armor().meleeHarvest().ranged().sixColor(0xFF9b6607, 0xFFd88a0a, 0xFFf0a31d, 0xFFffc461, 0xFFffd58e, 0xFFfff0d5))
            .buildMaterial();
    ...
    public static final MaterialId netherRuby = MaterialBuilder.material("betternether", "nether_ruby")
            ...
            .spriteInfo(s -> s.fallbacks("gem", "metal").repairKit().armor().meleeHarvest().ranged().sixColor(0xFF4c000b, 0xFF6a000f, 0xFFce1425, 0xFFeb4150, 0xFFf0747f, 0xFFf8c0c5))
            .buildMaterial();
