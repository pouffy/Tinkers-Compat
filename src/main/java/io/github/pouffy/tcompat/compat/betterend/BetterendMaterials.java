...
public class BetterendMaterials {
    ...
    public static final MaterialId thallasium = MaterialBuilder.material("betterend", "thallasium")
            ...
            .spriteInfo(s -> s.fallbacks("metal").repairKit().armor().meleeHarvest().ranged().sixColor(0xFF378099, 0xFF449aaf, 0xFF54b0bf, 0xFF7ad0d3, 0xFFa4e8da, 0xFFcff9e2))
            .buildMaterial();
    ...
    public static final MaterialId terminite = MaterialBuilder.material("betterend", "terminite")
            ...
            .spriteInfo(s -> s.fallbacks("metal").repairKit().armor().meleeHarvest().ranged().sixColor(0xFF01625b, 0xFF00a094, 0xFF46d5ca, 0xFF71f3e8, 0xFFa1f8f0, 0xFFebfefc))
            .buildMaterial();
    ...
    public static final MaterialId aeternium = MaterialBuilder.material("betterend", "aeternium")
            ...
            .spriteInfo(s -> s.fallbacks("metal").repairKit().armor().meleeHarvest().ranged().sixColor(0xFF0c100f, 0xFF282f2d, 0xFF495e5a, 0xFF697876, 0xFF8d9a96, 0xFFbdcbc9))
            .buildMaterial();
