...
import io.github.pouffy.tcompat.compat.ice_and_fire.modifier.defence.BreathlessModifier;
import io.github.pouffy.tcompat.compat.ice_and_fire.modifier.defence.FrostThornsModifier;
import io.github.pouffy.tcompat.compat.ice_and_fire.modifier.defence.ScorchThornsModifier;
import io.github.pouffy.tcompat.compat.ice_and_fire.modifier.defence.VoltThornsModifier;
import io.github.pouffy.tcompat.compat.ice_and_fire.modifier.combat.FlamedModifier;
import io.github.pouffy.tcompat.compat.ice_and_fire.modifier.combat.IcedModifier;
import io.github.pouffy.tcompat.compat.ice_and_fire.modifier.combat.LightningModifier;
import io.github.pouffy.tcompat.compat.ice_and_fire.modifier.combat.ranged.AmphithericModifier;
import io.github.pouffy.tcompat.compat.ice_and_fire.modifier.combat.ranged.LeechingModifier;
import io.github.pouffy.tcompat.compat.ice_and_fire.modifier.combat.ranged.StymphalianModifier;
...
public class IFInit extends CompatInitializer {
    ...
    public static final StaticModifier<AmphithericModifier> amphitheric = IF_M.register("amphitheric", AmphithericModifier::new);
    public static final StaticModifier<StymphalianModifier> stymphalian = IF_M.register("stymphalian", StymphalianModifier::new);
